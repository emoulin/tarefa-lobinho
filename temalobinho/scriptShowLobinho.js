...
let wolfTxt = document.querySelector('.wolfTxt')
let wolfName = document.querySelector('.wolfName')
...
function deleteWolf(id) {
    ...
    window.location.href = "/indexListaLobinhos.html" //nao sei se funciona
}
